...
namespace XNATBS
{
        ...
        public Coords NeighborInDirection(Direction dir)
        {
            switch (dir)
            {
                case (Direction.Northeast):
                    return new Coords(this.Type, this.X + (this.Y % 2), this.Y - 1);
                case (Direction.East):
                    return new Coords(this.Type, this.X + 1, this.Y);
                case (Direction.Southeast):
                    return new Coords(this.Type, this.X + (this.Y % 2), this.Y + 1);
                case (Direction.Southwest):
                    return new Coords(this.Type, this.X - ((this.Y + 1) % 2), this.Y + 1);
                case (Direction.West):
                    return new Coords(this.Type, this.X - 1, this.Y);
    ...
    public struct ItemGenerator
    {
        ...
        public readonly Dictionary<ItemProperty, float> functions;
    ...
    public struct CreatureGenerator
    {
        ...
        public readonly UInt16[] MainStatsMeans;
        public readonly UInt16[] MainStatsDeviations;

        public readonly UInt16[] APMoveCosts;
        public readonly UInt16[] APActionCosts;

        // NOTE: Spell generation delegated to Map class. This is bad design, but the current way classes are connected neccessitates this approach.
        public readonly Spells[] SpellEndowment;
    ...
    */
    ...
    public enum ItemProperty : sbyte
    {
        Damage = 0,
        Range,
        Protection
    ...
    public enum SpriteParticle : sbyte
    {
        ParticlePixel = 0,
        ParticleArrow,
        COUNT
